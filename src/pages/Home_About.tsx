    ...
    <section className="text-gray-600 body-font">
      <div className="container px-5 py-24 mx-auto flex flex-col">
        <div className="lg:w-5/6 mx-auto">
          <h1 className="text-3xl sm:text-4xl font-bold text-center text-[#f5efe6] mb-12">
            About Us
          </h1>
          ...
          <div className="flex flex-col sm:flex-row items-center sm:items-start gap-8">
            ...
            <div className="sm:w-1/3 w-full flex flex-col items-center text-center">
              <div className="w-48 h-48 sm:w-full sm:h-80 rounded-xl overflow-hidden shadow-md">
                <img
                  alt="Anthony Pendley"
              ...
              <h2 className="font-semibold text-[#b89d76] text-xl mt-4">
                Founder &amp; CEO
              </h2>
            </div>
            ...
            <div className="sm:w-2/3 sm:pl-8 sm:border-l border-[#b89d76] text-left space-y-4">
              ...
              <p className="leading-relaxed text-lg text-white">
                Over the past 15-plus years, I've worked across many areas of
              ...
              <div className="pt-2">
                ...
                <p className="text-2xl sm:text-3xl font-extrabold text-white tracking-tight mt-1">
